 ...
 * @return string
 */
function blockart_get_icon( $name, $echo = false, $args = array() ) {
 ...
 * @return string
 */
function blockart_string_to_kebab( $string ) {
 ...
 * Get setting object.
 *
 * @return \BlockArt\Setting
 */
function blockart_get_setting() {
	$setting = new \BlockArt\Setting();
	return $setting;
}
 ...
 * @return bool
 */
function blockart_string_to_bool( $string ) {
	if ( is_bool( $string ) ) {
		return $string;
	}
 ...
 * @return string
 */
function blockart_bool_to_string( $bool ) {
	if ( ! is_bool( $bool ) ) {
		$bool = blockart_string_to_bool( $bool );
	}
