...
class MaintenanceMode {
	...
	protected function __construct() {
		$this->setting = new \BlockArt\Setting();
	...
	protected function get_mode() {
		return $this->setting->get( 'maintenance-mode.mode', 'none' );
	}
	...
	protected function get_maintenance_page_id() {
		return $this->setting->get( 'maintenance-mode.maintenance-page', array() )['value'] ?? 0;
	}
